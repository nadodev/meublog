        ...
        <section class="hero">
            <div class="container-2xl">
                <div class="hero__content">
                    ...
                    <h1>Criando interfaces visuais na web com foco
                        <span><strong> na excelência do usuário.</strong></span>
                    </h1>
                    <a href="{{ route('curriculo.index') }}" target="_blank" rel="noopener noreferrer" class="btn-myresume">Meu
                    Currículo
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 h-6">
        ...
        <section class="approch">
            <div class="container-2xl">
                <div class="approch__header flex flex-col  md:flex-row w-full items-center">
                    <h2>Qual é o meu fluxo de trabalho?</h2>
                ...
                <div class="approch__wrapper">
                    <div class="approch__item">
                        ...
                        <p class="text-md">Nesta etapa, eu identifico e avalio qual problema precisa ser resolvido, determino os requisitos do projeto e estabeleço a arquitetura ideal para a implementação.</p>
                    </div>
                    <div class="approch__item">
                        <h3 class="font-black text-2xl">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        ...
                        <p>Nesta fase, implemento a estratégia definida anteriormente, dividindo-a em tarefas menores e garantindo que todos os requisitos e estruturas sejam otimizados da melhor forma possível.</p>
                    </div>
                    <div class="approch__item">
                        <h3 class="font-black text-2xl">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        ...
                        <p>Nesta fase final, realizo testes para garantir que tudo esteja funcionando da maneira mais eficaz possível e, por fim, crio a documentação.</p>
                    </div>
                </div>
            </div>
        </section>
